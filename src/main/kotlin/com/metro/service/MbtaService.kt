...
import com.metro.client.http.MbtaClient
import com.metro.service.model.Route
...
import com.metro.service.model.Stop
import com.metro.service.model.StopInfo
import com.metro.service.model.StopInfos
import com.metro.service.model.StopNode
...
class MbtaService(private val mbtaClient: MbtaClient) : MetroService {
    ...
    fun searchTripRoutes(beginStopName: String,
        ...
        val beginStopId = stopNameToStopId[beginStopName] ?: throw IllegalArgumentException("Begin stop not found")
        val endStopId = stopNameToStopId[endStopName] ?: throw IllegalArgumentException("End stop not found")
