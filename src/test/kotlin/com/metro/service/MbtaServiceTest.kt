...
import com.metro.service.model.RouteAttributes
import com.metro.service.model.Stop
import com.metro.service.model.StopAttributes
...
internal class MbtaServiceTest {
    ...
    fun testGetStopsWithMultipleRoutes() {
        ...
        assertTrue(stopsWithMultipleRoutes.stopInfos?.map { it.stopName }?.contains("State")
                           ?: false, "Stop State not found")
        assertTrue(stopsWithMultipleRoutes.stopInfos?.map { it.stopName }?.contains("Downtown")
